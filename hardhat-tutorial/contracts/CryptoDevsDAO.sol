...
contract CryptoDevsDAO is Ownable {
        ...
        inactiveProposalOnly(proposalIndex)
    {
        ...
        proposal.executed = true; // exectuded regardless of the result
    }
    ...
    function withdrawEther() external onlyOwner {
        ...
        payable(owner()).transfer(amount);  // Not recomended anymore (use this as it is the one in the lesson)
        // (bool sent, ) = _to.call{value: amount}(""); // recomended current way
